        ...
        <div class="row d-flex justify-content-center">
            ...
            <nav class="navbar navbar-dark bg-dark nav-pills nav-tabs navbar-expand-sm w-100" dir="rtl">
                ...
                <div class="collapse navbar-collapse" id="myToggleNav">
                    ...
                    <div id="navbar" class="col-10 navbar-nav text-center">
                        <a href="index.php" class="nav-link nav-item active text-white">سیاسی</a>
            ...
            <div id="indexbg" dir="rtl">
                ...
                <div class="d-flex" style="margin-top: 10vh;">
                    <img src="img/News/logo-af.jpg" alt="TOLO NEWS" id="mainLogo" class="img-fluid m-auto" title="طلوع نیوز" style="cursor: pointer;">
                </div>
            ...
            <main class="col-xl-8 offset-xl-0 col-lg-6 col-md-7 offset-md-0 col-sm-8 col-10 mt-3" dir="rtl">
                ...
                <div class="d-xl-flex flex-xl-wrap">
                    ...
                    <div class="card col-12 mt-3">
                        <marquee class="card-header text-right text-white h3 bg-danger">تازه ترین رویداد های افغانستان منطقه و جهان</marquee>
                    </div>

                    <?php

                    $sql = "SELECT post_id, `image`, content, `date` FROM post WHERE `type`='سیاسی' ORDER BY post_id DESC";
                            ...
                            <div class="col-xl-6 col-lg-12 mt-3" dir="rtl">
                                <div class="card">
                                    <div class="card-body d-flex flex-wrap">
                                        <a href="single.php?postId=<?php echo $res->id ?>"> <img src="img/News/<?php echo $res->image ?>" class="img-thumbnail w-100" style="height: 250px"></a>
                                        ...
                                        <div class="border p-3 rounded d-flex col-12 justify-content-around" dir="ltr">
                                            <div class="d-flex">
                                                ...
                                                $view = "SELECT COUNT(view_id) AS allView FROM view WHERE post_id=?";
